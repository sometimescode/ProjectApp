...
<html lang="en">
  ...
  <body>
    ...
    <a href="<s:url action='viewAccount' namespace='/user'/>">View Account Details</a>
    ...
    <s:iterator value="checkedOutBooks" status="checkedOutBooksStatus">
        <p>
            ...
            <s:property value="%{#checkedOutBooksStatus.count}" />
    ...
    <s:iterator value="pendingCheckoutRequests" status="pendingCheckoutRequestsStatus">
        <p>
          ...
          <s:url action="cancelCheckoutRequest" namespace="/user" var="cancelTag" >
          ...
          Title: <s:property value="joinBookEntryTitle"/>
          Request Date: <s:property value="requestDate"/>
          <s:if test="(status == 'Approved' || status == 'Pending') && checkoutRecordId == 0">
          Action: <s:a href="%{cancelTag}">Cancel</s:a>
          </s:if>
        </p>
    </s:iterator>
